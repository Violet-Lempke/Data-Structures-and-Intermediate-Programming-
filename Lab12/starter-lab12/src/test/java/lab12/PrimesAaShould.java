...
public class PrimesAaShould {
    ...
    void find_primes_to_100() throws Exception {
        assertEquals(25, Primes.findPrimes(100, 1).size());
        assertEquals(25, Primes.findPrimes(100, 8).size());
    }

    @Test
    void find_primes_to_10000() throws Exception {
        assertEquals(1229, Primes.findPrimes(10000, 1).size());
        assertEquals(1229, Primes.findPrimes(10000, 8).size());
    }

    @Test
    void find_primes_to_1000000() throws Exception {
        assertEquals(78498, Primes.findPrimes(1000000, 8).size());
    }
}
