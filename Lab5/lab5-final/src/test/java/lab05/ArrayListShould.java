...
public class ArrayListShould {
    ...
    void test_map() {
        ...
        assertEquals("[2 4 6 8 14 ]", a5.toString());

        String[] letters = {"hi", "hello", "hey", "greetings"};
        var a6 = new ArrayList<String>(letters);
        var a7 = a6.map((xx) -> xx + "a");
        assertEquals("[hia helloa heya greetingsa ]", a7.toString());
    }
